...
export type InspectionBatchAssignmentDtoPagedResultDtoAjaxResponse = {
  result?: InspectionBatchAssignmentDtoPagedResultDto;
  targetUrl?: string | null;
  success?: boolean;
  error?: ErrorInfo;
  unAuthorizedRequest?: boolean;
...
export type InspectionBatchAssignmentUpdateProps = Omit<
  MutateProps<InspectionBatchAssignmentDtoAjaxResponse, AjaxResponseBase, void, InspectionBatchAssignmentDto>,
  'path' | 'verb'
>;

export const InspectionBatchAssignmentUpdate = (props: InspectionBatchAssignmentUpdateProps) => (
  <Mutate<InspectionBatchAssignmentDtoAjaxResponse, AjaxResponseBase, void, InspectionBatchAssignmentDto>
    verb="PUT"
...
export type UseInspectionBatchAssignmentUpdateProps = Omit<
  UseMutateProps<InspectionBatchAssignmentDtoAjaxResponse, void, InspectionBatchAssignmentDto>,
  'path' | 'verb'
>;

export const useInspectionBatchAssignmentUpdate = (props: UseInspectionBatchAssignmentUpdateProps) =>
  useMutate<InspectionBatchAssignmentDtoAjaxResponse, AjaxResponseBase, void, InspectionBatchAssignmentDto>(
    'PUT',
...
export type InspectionBatchAssignmentGetAllProps = Omit<
  GetProps<
    InspectionBatchAssignmentDtoPagedResultDtoAjaxResponse,
    AjaxResponseBase,
    InspectionBatchAssignmentGetAllQueryParams
  >,
  'path'
>;
...
export type UseInspectionBatchAssignmentGetAllProps = Omit<
  UseGetProps<InspectionBatchAssignmentDtoPagedResultDtoAjaxResponse, InspectionBatchAssignmentGetAllQueryParams>,
  'path'
>;
...
export const useInspectionBatchAssignmentGetAll = (props: UseInspectionBatchAssignmentGetAllProps) =>
  useGet<
    ...
    AjaxResponseBase,
    InspectionBatchAssignmentGetAllQueryParams
  >(`/api/services/propertyInspection/InspectionBatchAssignment/GetAll`, props);
...
export type InspectionBatchAssignmentDeleteProps = Omit<
  MutateProps<void, unknown, InspectionBatchAssignmentDeleteQueryParams, void>,
  'path' | 'verb'
>;

export const InspectionBatchAssignmentDelete = (props: InspectionBatchAssignmentDeleteProps) => (
  <Mutate<void, unknown, InspectionBatchAssignmentDeleteQueryParams, void>
    verb="DELETE"
...
export const useInspectionBatchAssignmentDelete = (props: UseInspectionBatchAssignmentDeleteProps) =>
  useMutate<void, unknown, InspectionBatchAssignmentDeleteQueryParams, void>(
    'DELETE',
